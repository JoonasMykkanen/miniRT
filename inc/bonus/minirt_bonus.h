...
void					init_cyl(t_cylinder *cyl, const t_ray r,
							t_helpc2 *point);
void					init_camera(t_data *data, double vp_height,
							double vp_width);
double					hit_cap(t_ray r, t_vector pos, t_vector normal,
							t_cylinder *cyl);
...
double					cylinder_light(t_data *data, t_vector inter, int i,
							int idx);
t_color					calculate_color(t_data *data, t_obj *obj,
							t_vector inter, int i);
double					calculate_cap(t_data *data, t_vector inter, int i,
							int idx);
double					calculate_body(t_data *data, t_vector inter, int i,
							int idx);
void					check_reflections(t_data *data, t_vector inter,
							t_color surface, int i);
...
t_ray					ray_create(const t_vector origin,
